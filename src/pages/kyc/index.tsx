                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12}>
                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={2.3}>
                        <TextField label="State" variant="filled" fullWidth defaultValue={selectedKYC?.residentialAddressState} disabled />
                      </Grid>
                      <Grid item xs={2.3}>
                        <TextField label="Zip Code" variant="filled" fullWidth defaultValue={selectedKYC?.residentialAddressZip} disabled />
                      </Grid>
                      <Grid item xs={2.3}>
                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={2.3}>
                        <TextField
                          ...
                          disabled
                          //@ts-ignore
                          defaultValue={selectedKYC?.postalAddressState}
                        />
                      </Grid>
                      <Grid item xs={2.3}>
                        <TextField
                          ...
                          disabled
                          //@ts-ignore
                          defaultValue={selectedKYC?.postalAddressZip}
                        />
                      </Grid>
                      <Grid item xs={2.3}>
                        <TextField
