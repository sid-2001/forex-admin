...
import CountryLabelFieldsService, {
  CountryLabelField
} from "../../services/country-label-fields.service";
    ...
    try {
      const payload = {
        ...
        effectiveToDate: form.effectiveToDate ? 
          new Date(form.effectiveToDate).toISOString() : null
      };
    ...
    { 
      ...
      renderCell: (params: GridRenderCellParams) => (
        <Chip 
          label={params.value} 
          size="small" 
          color={params.value === "STRING" ? "primary" : "secondary"}
        />
      )
    },
    { 
  ...
  return (
    <Box sx={{ height: "100vh", p: 3 }}>
      <Stack direction="row" justifyContent="space-between" mb={2}>
        <Typography variant="h5">Country Label Fields</Typography>
      ...
      <Dialog open={open} onClose={() => setOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>
          {selected ? "Edit Field" : "Create New Field"}
        </DialogTitle>
