...
//     // Use the auto-generated code as ID for the URL
...
//     { field: 'countryKycDocCode', headerName: 'Doc Code', flex: 1 },
//     { field: 'countryCode', headerName: 'Country', flex: 0.7 },
//     { field: 'countryKycDocDescription', headerName: 'Description', flex: 1.5 },
//     { field: 'active', headerName: 'Active', flex: 0.5, renderCell: (p) => (p.value ? 'Yes' : 'No') },
//     {
//       field: 'actions',
//       headerName: 'Actions',
//       width: 80,
...
//         <DataGrid rows={rows} columns={columns} loading={loading} getRowId={(r) => r.countryKycDocCode} />
//       </div>
//       {open && (
//         <CountryKycDocDialog
//           open={open}
