    ...
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      ...
      <DialogContent dividers>
        <Grid container spacing={2} sx={{ mt: 1 }}>
          ...
          <Grid item xs={3}>
            <TextField fullWidth label="Faq Type" value={formData.faqType} onChange={(e) => handleChange('faqType', e.target.value)} />
          </Grid>
          <Grid item xs={3}>
            <TextField
              fullWidth
              ...
              onChange={(e) => handleChange('faqQuestionCount', e.target.value)}
            />
          </Grid>
